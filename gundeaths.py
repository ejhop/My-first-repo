...
Original file is located at
    https://colab.research.google.com/drive/1_qtMWfehoY9-H9PtSFf-Fg47WtH36V9K
"""
...
# Title of the app
st.title("CFirearm Deaths in New Mexico")
...
if uploaded_file is not None:
    ...
    y_column = st.selectbox("Deaths per 100,000 people", columns)
